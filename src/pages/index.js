      ...
      <div className="container mx-auto px-8 lg:flex">
        <div className="text-center lg:text-left lg:w-1/2">
          <h3 className="font-semibold">
            Adelanta tu salario cuando lo necsesites.
          </h3>
          <p className="text-lg  mt-6 font-light">
            Con nuestra app Monet puedes adelantar hasta $500.000 al instante
            desde tu celular. Sin estudios de crédito, sin intereses y con un
            costo único de $5.000 + IVA por retiro.
          </p>
